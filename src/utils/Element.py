...
if __name__ == '__main__':
    ...
    print("A",cal_mass_by_formula(elements,"C(5)H(4)N(5)"))
    print("U",cal_mass_by_formula(elements,"C(4)H(3)N(2)O(2)"))
    print("C",cal_mass_by_formula(elements,"C(4)H(4)N(3)O(1)"))
    print("G",cal_mass_by_formula(elements,"C(5)H(4)N(5)O(1)"))
